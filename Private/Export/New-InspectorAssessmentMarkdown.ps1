function New-InspectorAssessmentMarkdown {
    ...
    $lines.Add("| Active role schedule instances collected | $(Get-InspectorExportProperty -InputObject $scopeInventory -Name 'RoleAssignmentScheduleInstancesDiscovered') |")
    $lines.Add("| Eligible role schedule instances collected | $(Get-InspectorExportProperty -InputObject $scopeInventory -Name 'RoleEligibilityScheduleInstancesDiscovered') |")
